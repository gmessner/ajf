...
/**
 * This class simply extends JCheckBoxMenuItem so it can monitor for
 ...
 */
public class ToggleMenuItemExt extends JCheckBoxMenuItem
	...
	public ToggleMenuItemExt(String label, String keyBinding) {
		super(label);
