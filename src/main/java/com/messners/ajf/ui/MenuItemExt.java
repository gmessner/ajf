...
/**
 * This class simply extends JMenuItem so it can monitor for
...
public class MenuItemExt extends JMenuItem
	...
	public MenuItemExt(String label, String keyBinding) {
		this(label, null, keyBinding);
	}

	public MenuItemExt(String label, Icon icon, String keyBinding) {
