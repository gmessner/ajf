...
/**
 * This class simply extends JToggleButton so it can monitor for
 ...
 */
public class ToggleButtonExt extends JToggleButton
	 ...
	 */
	public ToggleButtonExt (Action action) {
		super(action);
	}
	 ...
	 */
	public ToggleButtonExt (Icon icon) {
		super(icon);
	}
	 ...
	 */
	public ToggleButtonExt (String text) {
		super(text);
	}
	 ...
	 * @param icon  the Icon image to display on the button
	 */
	public ToggleButtonExt (String text, Icon icon) {
		super(text, icon);
	}
