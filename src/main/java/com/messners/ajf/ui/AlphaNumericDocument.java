...
/**
 * Document that accepts alpha-numeric characters for use in <code>JTextComponent</code> instances.
 *
...
public class AlphaNumericDocument extends PlainDocument {
     ...
     */
    public AlphaNumericDocument(int maxChars, boolean ignoreWs) {
    ...
    public void insertString(int offs, String str, AttributeSet a) 
        ...
        if (strValid && StringUtils.isAlphaNumeric(str, ignoreWhitespaces)) {
